...
- [`Prismatic/PathInfrastructure.lean`](Prismatic/PathInfrastructure.lean) — prisms and Breuil-Kisin module compatibilities packaged with domain-specific `Path.Step` witnesses and derived `RwEq` normalizations.
