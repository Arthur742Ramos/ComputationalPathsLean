...
- `ComputationalPaths/Path/Basic/Globular.lean` - iterated identity tower yielding the globular set generated by computational paths and closing it under `refl`/`symm`/`trans` dimension-wise.
