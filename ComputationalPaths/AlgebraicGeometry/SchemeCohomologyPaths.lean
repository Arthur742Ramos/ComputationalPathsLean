...
@[simp] theorem addAssoc_rweq (m₁ m₂ m₃ : Mod) :
    RwEq
...
@[simp] theorem restrictCompat_rweq (f : Section) (m : Mod) :
    RwEq
...
@[simp] theorem mapAdd_rweq (m₁ m₂ : Mod₁) :
    RwEq
...
@[simp] theorem mapAdd_cancel_rweq (m₁ m₂ : Mod₁) :
    RwEq
      (Path.trans (Path.symm (φ.mapAddPath m₁ m₂)) (φ.mapAddPath m₁ m₂))
      (Path.refl (φ.target.add (φ.mapMod m₁) (φ.mapMod m₂))) :=
  rweq_cmpA_inv_left (φ.mapAddPath m₁ m₂)

@[simp] theorem mapScalar_cancel_rweq (s : Section) (m : Mod₁) :
    RwEq
...
@[simp] theorem coboundarySquare_rweq (c : Cochain) :
    RwEq
...
@[simp] theorem cocycleCond_rweq (z : Cocycle) :
    RwEq
...
@[simp] theorem coboundaryExact_rweq (c : Cochain) :
    RwEq
...
@[simp] theorem addCochain_rweq (c₁ c₂ : Cochain) :
    RwEq
...
@[simp] theorem refinement_rweq (z : Cocycle) :
    RwEq
...
@[simp] theorem coboundarySquare_cancel_rweq (c : Cochain) :
    RwEq
...
@[simp] theorem cocycleCond_cancel_rweq (z : Cocycle) :
    RwEq
...
@[simp] theorem exactAt1_rweq (h : H0) :
    RwEq
...
@[simp] theorem exactAt2_rweq (h : H1) :
    RwEq
...
@[simp] theorem exactAt0_rweq (h : H2) :
    RwEq
...
@[simp] theorem connectingNat_rweq (h : H2) :
    RwEq
...
@[simp] theorem pairingComm_rweq (h : Hi) (g : Hni) :
    RwEq
...
@[simp] theorem dualCompat_rweq (h : Hi) (g : Hni) :
    RwEq
...
@[simp] theorem traceIdempotent_rweq (p : Pairing) :
    RwEq
...
@[simp] theorem serrePerfect_rweq (h : Hi) :
    RwEq
...
@[simp] theorem dualCompat_cancel_rweq (h : Hi) (g : Hni) :
    RwEq
...
@[simp] theorem traceIdempotent_cancel_rweq (p : Pairing) :
    RwEq
...
@[simp] theorem additivity_rweq (d₁ d₂ : Dim) :
    RwEq
...
@[simp] theorem shortExactEuler_rweq (a b : Dim) :
    RwEq
...
@[simp] theorem additivity_cancel_rweq (d₁ d₂ : Dim) :
    RwEq
...
@[simp] theorem tensorRR_rweq (d₁ d₂ : Dim) :
    RwEq
...
@[simp] theorem rrFormula_cancel_rweq :
    RwEq
...
@[simp] theorem twist_cancel_rweq (d : Dim) :
    RwEq
...
@[simp] theorem linEquiv_rweq (d₁ d₂ : Div) :
    RwEq
...
@[simp] theorem divAddAssoc_rweq (d₁ d₂ d₃ : Div) :
    RwEq
...
@[simp] theorem k0AddAssoc_rweq (a b c : K) :
    RwEq
...
@[simp] theorem tensorProduct_rweq (a b : K) :
    RwEq
