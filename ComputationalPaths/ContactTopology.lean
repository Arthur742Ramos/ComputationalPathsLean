...
def legendrian_isotopy_path (L : LegendreSubmanifold) :
  ...
  stepChainOfEq (LegendreIsotopy.identity_eq L)
...
def standard_class_path (n : Nat) :
  ...
  stepChainOfEq (ContactClassification.standard_is_tight n)
