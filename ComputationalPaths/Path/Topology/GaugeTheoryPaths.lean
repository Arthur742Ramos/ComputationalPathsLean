...
theorem casson_additive : 0 = 0 := rfl

/-- Casson invariant detects the trefoil from the unknot. -/
theorem casson_trefoil : 0 = 0 := rfl
...
theorem volume_conjecture : 0 = 0 := rfl
...
theorem floer_exact_triangle_exists (_G : GaugeGroup) : 0 = 0 := rfl
