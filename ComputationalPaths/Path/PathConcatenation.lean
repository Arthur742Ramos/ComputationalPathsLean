...
noncomputable def trans_four_assoc (p : Path a b) (q : Path b c) (r : Path c d) (s : Path d e) :
...
noncomputable def trans_five_assoc (p : Path a b) (q : Path b c) (r : Path c d) (s : Path d e)
    (t : Path e f) :
...
noncomputable def trans_triangle (p : Path a b) (q : Path b c) :
...
noncomputable def trans_refl_left_assoc (p : Path a b) (q : Path b c) :
...
noncomputable def trans_refl_right_assoc (p : Path a b) (q : Path b c) :
...
noncomputable def trans_unit_swap (p : Path a b) :
