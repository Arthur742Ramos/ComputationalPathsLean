...
noncomputable def samelson_congr {p p' q q' : LoopSpace A a}
...
noncomputable def samelson_refl_left (p : LoopSpace A a) :
...
noncomputable def samelson_refl_right (p : LoopSpace A a) :
...
noncomputable def samelson_self (p : LoopSpace A a) :
