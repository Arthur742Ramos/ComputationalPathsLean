...
@[simp] theorem addAssoc_rweq (x y z : A) :
...
theorem addZero_transport_const {B : Type v} (x : A) (b : B) :
...
@[simp] theorem compositionZero_cancel_rweq (a : A) :
    RwEq
...
@[simp] theorem leftSq_cancel_rweq (a : A) :
...
@[simp] theorem rightSq_cancel_rweq (b : B) :
...
@[simp] theorem connecting_rweq (c : C) (kerP : Path (S.γ.map c) GC'.zero)
    (b : B) (liftP : Path (S.g.map b) c) :
    RwEq
...
theorem connecting_transport_const {D : Type v}
...
theorem connect_transport_const {D : Type v} (n : Int) (c : C) (d : D) :
...
theorem liftPath_transport_const {D : Type v} (p : P) (d : D) :
...
theorem ddZero_transport_const {D : Type v} (n : Nat) (x : A) (d : D) :
...
@[simp] theorem ddRoundTrip_rweq (n : Nat) (x : A) :
...
@[simp] theorem ddStar_rweq (n : Nat) (b : B) :
...
@[simp] theorem ddStar_cancel_rweq (n : Nat) (b : B) :
...
theorem ddStar_transport_const {D : Type v} (n : Nat) (b : B) (d : D) :
...
@[simp] theorem ddTensor_rweq (n : Nat) (b : B) :
...
@[simp] theorem ddTensor_cancel_rweq (n : Nat) (b : B) :
...
@[simp] theorem directSumDd_rweq (n : Nat) (a : A) (c : C) :
    RwEq
...
@[simp] theorem directSumDd_cancel_rweq (n : Nat) (a : A) (c : C) :
    RwEq
...
theorem directSumDd_transport_const {D : Type v} (n : Nat) (a : A) (c : C) (d : D) :
...
theorem comm_transport_const {D : Type v} (n : Nat) (x : A) (d : D) :
...
@[simp] theorem derivedDd_rweq (n : Nat) (b : B) :
...
@[simp] theorem derivedDd_cancel_rweq (n : Nat) (b : B) :
...
theorem dHdH_transport_const {B : Type v} (p q : Int) (x : A) (b : B) :
...
theorem chainComm_transport_const {D : Type v} (n : Int) (x : A) (d : D) :
...
@[simp] theorem exactA_cancel_rweq (n : Nat) (m : M) :
...
@[simp] theorem homotopy_cancel_rweq (n : Int) (x : A) :
...
theorem homotopy_transport_const {D : Type v} (n : Int) (x : A) (d : D) :
...
theorem ddR_transport_const {D : Type v} (r : Nat) (p q : Int) (x : A) (d : D) :
...
@[simp] theorem cokernel_cancel_rweq (f : A → A) (y : A) :
