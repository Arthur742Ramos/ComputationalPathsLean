...
-- ============================================================================
noncomputable def star_quad (a : A.Carrier) :
...
-- ============================================================================
noncomputable def star_triple_product (a b c : A.Carrier) :
...
-- ============================================================================
noncomputable def star_add_comm (a b : A.Carrier) :
...
-- ============================================================================
noncomputable def norm_star_star (a : A.Carrier) :
...
-- ============================================================================
noncomputable def cstar_id_star (a : A.Carrier) :
...
-- ============================================================================
noncomputable def one_mul_symm (a : A.Carrier) :
...
-- ============================================================================
noncomputable def mul_assoc4 (a b c d : A.Carrier) :
...
-- ============================================================================
noncomputable def rep_triple_mul (a b c : S.alg.Carrier) (h : S.HSpace) :
...
-- ============================================================================
noncomputable def rep_one_one (h : S.HSpace) :
...
-- ============================================================================
noncomputable def dirac_selfadj_symm (h1 h2 : S.HSpace) :
...
-- ============================================================================
noncomputable def rep_zero_dirac (h : S.HSpace) :
...
-- ============================================================================
noncomputable def dirac_selfadj_chain (h1 h2 _h3 : S.HSpace) :
...
noncomputable def connesMetric (A : CStarAlg.{u}) (phi psi : PureState A) : A.Carrier :=
  A.norm (A.add (phi.eval A.one) (A.star (psi.eval A.one)))

-- ============================================================================
-- Theorem 13: Connes distance reflexivity
-- ============================================================================
noncomputable def connes_refl (phi : PureState A) :
...
-- ============================================================================
noncomputable def connes_normalized (phi psi : PureState A) :
...
-- ============================================================================
noncomputable def connes_star_one (_phi _psi : PureState A) :
...
noncomputable def hochschild_b (A : CStarAlg.{u}) (phi : HochschildCochain A) :
...
-- ============================================================================
noncomputable def hochschild_b_zero (phi : HochschildCochain A) :
...
-- ============================================================================
noncomputable def hochschild_b_star_comm (phi : HochschildCochain A) (a : A.Carrier) :
...
-- ============================================================================
noncomputable def hochschild_b2_eval (phi : HochschildCochain A) (a : A.Carrier) :
...
-- ============================================================================
noncomputable def hochschild_b2_star_part (phi : HochschildCochain A) (a : A.Carrier) :
...
-- ============================================================================
noncomputable def hochschild_b2_involution (phi : HochschildCochain A) (a : A.Carrier) :
...
-- ============================================================================
noncomputable def cyclic_B_zero (phi : CyclicCochain A) :
...
-- ============================================================================
noncomputable def cyclic_one_mul (phi : CyclicCochain A) :
...
-- ============================================================================
noncomputable def cyclic_star_chain (phi : CyclicCochain A) :
...
-- ============================================================================
noncomputable def proj_star_squared (e : Projection A) :
...
-- ============================================================================
noncomputable def proj_star_sq_is_proj (e : Projection A) :
...
-- ============================================================================
noncomputable def chernChar (e : Projection A) : A.Carrier :=
  A.add e.elem (A.star e.elem)

-- ============================================================================
-- Theorem 27: For self-adjoint projection, ch(e) = e + e
-- ============================================================================
noncomputable def chern_double (e : Projection A) :
...
-- ============================================================================
noncomputable def chern_selfadj (e : Projection A) :
...
-- ============================================================================
noncomputable def chern_star_simplify (e : Projection A) :
...
-- ============================================================================
noncomputable def chern_star_full (e : Projection A) :
...
-- ============================================================================
noncomputable def chern_star_is_chern (e : Projection A) :
...
-- ============================================================================
noncomputable def morita_lAct_triple (a1 a2 a3 : A.Carrier) (m : M.Mod) :
...
-- ============================================================================
noncomputable def morita_lAct_one_symm (m : M.Mod) :
...
-- ============================================================================
noncomputable def morita_ip_double_conj (m n : M.Mod) :
...
-- ============================================================================
noncomputable def morita_ip_conj_chain (m n : M.Mod) :
    Path (A.star (A.star (M.ipA m n))) (M.ipA m n) :=
  Path.trans
...
-- ============================================================================
noncomputable def morita_compat_one (m : M.Mod) :
...
-- ============================================================================
noncomputable def morita_compat_simplify (m : M.Mod) :
...
-- ============================================================================
noncomputable def nctorus_comm_rev :
...
-- ============================================================================
noncomputable def nctorus_star_UV :
...
-- ============================================================================
noncomputable def nctorus_star_VU :
...
-- ============================================================================
noncomputable def nctorus_star_VU_expanded :
    Path (T.alg.star (T.alg.mul T.V T.U))
...
-- ============================================================================
noncomputable def nctorus_U_norm :
...
-- ============================================================================
noncomputable def spectral_trace_cyclic (a b c : SA.triple.alg.Carrier) :
...
-- ============================================================================
noncomputable def spectral_trace_star (a : SA.triple.alg.Carrier) :
...
-- ============================================================================
noncomputable def spectral_trace_linear_chain (a b c : SA.triple.alg.Carrier) :
...
-- ============================================================================
noncomputable def fredholm_F_triple (h : FM.HSpace) :
...
-- ============================================================================
noncomputable def fredholm_F_quad (h : FM.HSpace) :
...
-- ============================================================================
noncomputable def fredholm_F_rep_prod (a b : FM.alg.Carrier) (h : FM.HSpace) :
...
-- ============================================================================
noncomputable def index_pairing (e : Projection FM.alg) (h : FM.HSpace) :
...
-- ============================================================================
noncomputable def index_pairing_idem (e : Projection FM.alg) (h : FM.HSpace) :
...
-- ============================================================================
noncomputable def kk_lAct_triple (a1 a2 a3 : A.Carrier) (m : KAB.Mod) :
...
-- ============================================================================
noncomputable def kk_F_triple (m : KAB.Mod) :
...
-- ============================================================================
noncomputable def kk_F_quad (m : KAB.Mod) :
...
-- ============================================================================
noncomputable def kk_F_lAct_triple (a1 a2 a3 : A.Carrier) (m : KAB.Mod) :
...
-- ============================================================================
noncomputable def kk_F_one (m : KAB.Mod) :
...
-- ============================================================================
noncomputable def kk_one_F_chain (m : KAB.Mod) :
...
-- ============================================================================
noncomputable def kk_rAct_triple (b1 b2 b3 : B.Carrier) (m : KAB.Mod) :
...
-- ============================================================================
noncomputable def star_add_rev (a b : A.Carrier) :
...
-- ============================================================================
noncomputable def cstar_norm_chain (a : A.Carrier) :
...
-- ============================================================================
noncomputable def norm_star_product_chain (a : A.Carrier) :
    Path (A.norm (A.mul (A.star (A.star a)) (A.star a)))
         (A.mul (A.norm (A.star a)) (A.norm (A.star a))) :=
  A.cstar_id (A.star a)
...
-- ============================================================================
noncomputable def full_norm_chain (a : A.Carrier) :
...
-- ============================================================================
noncomputable def morita_ip_involution (m n : M.Mod) :
    Path (A.star (A.star (M.ipA m n))) (M.ipA m n) :=
  A.star_star (M.ipA m n)
...
-- ============================================================================
noncomputable def morita_full_conj_chain (m n : M.Mod) :
    Path (A.star (A.star (M.ipA m n))) (M.ipA m n) :=
  Path.trans
    (congrArg A.star (M.ip_conj m n))
    (M.ip_conj n m)
...
-- ============================================================================
noncomputable def nctorus_star_rel_chain :
    Path (T.alg.star (T.alg.mul T.V T.U))
...
-- ============================================================================
noncomputable def spectral_rep_one_chain (h : S.HSpace) :
...
-- ============================================================================
noncomputable def gelfand_rep_triple (a b c : A.Carrier) (h : GN.Hilb) :
...
-- ============================================================================
noncomputable def gelfand_rep_one_one (h : GN.Hilb) :
...
-- ============================================================================
noncomputable def gelfand_faithful_cyc (a : A.Carrier) :
...
-- ============================================================================
noncomputable def real_sym_quad (h : RG.triple.HSpace) :
...
-- ============================================================================
noncomputable def real_gam_quad (h : RG.triple.HSpace) :
...
-- ============================================================================
noncomputable def real_sym_gam_roundtrip (h : RG.triple.HSpace) :
...
-- ============================================================================
noncomputable def real_sym_after_gam_sq (h : RG.triple.HSpace) :
...
-- ============================================================================
noncomputable def real_gam_after_sym_sq (h : RG.triple.HSpace) :
...
-- ============================================================================
noncomputable def deformation_zeroth (a b : A.Carrier) :
...
-- ============================================================================
noncomputable def deformation_unit_chain (a : A.Carrier) :
...
-- ============================================================================
noncomputable def deformation_first_order (a b : A.Carrier) :
...
-- ============================================================================
noncomputable def deformation_first_symm (a b : A.Carrier) :
...
-- ============================================================================
noncomputable def deformation_first_chain (a b : A.Carrier) :
