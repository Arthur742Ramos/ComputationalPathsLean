...
theorem norm_ex1 : canon (.trans .refl (.atom 0)) = .atom 0 := by native_decide

/-- `symm (symm (atom 0))` normalizes to `atom 0`. -/
theorem norm_ex2 : canon (.symm (.symm (.atom 0))) = .atom 0 := by native_decide

/-- `trans (atom 0) (symm (atom 0))` normalizes to `refl`. -/
theorem norm_ex3 : canon (.trans (.atom 0) (.symm (.atom 0))) = .refl := by native_decide

/-- `trans (symm (atom 0)) (atom 0)` normalizes to `refl`. -/
theorem norm_ex4 : canon (.trans (.symm (.atom 0)) (.atom 0)) = .refl := by native_decide
...
theorem norm_ex5 : canon (.trans (.trans (.atom 0) (.atom 1)) (.atom 2)) =
    .trans (.atom 0) (.trans (.atom 1) (.atom 2)) := by native_decide

/-- `symm (trans (atom 0) (atom 1))` normalizes to `trans (symm (atom 1)) (symm (atom 0))`. -/
theorem norm_ex6 : canon (.symm (.trans (.atom 0) (.atom 1))) =
    .trans (.symm (.atom 1)) (.symm (.atom 0)) := by native_decide

/-- A complex expression with cancellation. -/
theorem norm_ex7 :
    canon (.trans (.atom 0) (.trans (.symm (.atom 0)) (.atom 1))) = .atom 1 := by native_decide

/-- Double symm tower normalizes. -/
theorem norm_ex8 : canon (.symm (.symm (.symm (.symm (.atom 0))))) = .atom 0 := by native_decide
...
theorem toRW_trans_01 :
    toRW (.trans (.atom 0) (.atom 1)) = [Gen.pos 0, Gen.pos 1] := by native_decide

/-- Cancellation in the free group. -/
theorem toRW_cancel :
    toRW (.trans (.atom 0) (.symm (.atom 0))) = [] := by native_decide
