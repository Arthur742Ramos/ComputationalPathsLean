...
noncomputable def pentagon_two_step (a b c d : V) :
...
noncomputable def assocPath_congrArg (a b c : V) (f : V → V) :
...
noncomputable def assocCoherencePath (a b c d : C.Obj) :
...
noncomputable def assocCoherenceInv (a b c d : C.Obj) :
...
noncomputable def leftUnitPath (a b : C.Obj) :
...
noncomputable def compCoherencePath (a b c : C.Obj) :
...
noncomputable def compCoherenceInv (a b c : C.Obj) :
...
noncomputable def idCoherencePath (a : C.Obj) :
...
noncomputable def naturalityPath (alpha : VNatTrans F G) (a b : C.Obj) :
...
noncomputable def naturalityInv (alpha : VNatTrans F G) (a b : C.Obj) :
...
noncomputable def naturality_roundtrip (alpha : VNatTrans F G) (a b : C.Obj) :
    Path (M.tensor (D.comp (F.objMap a) (G.objMap a) (G.objMap b)) (G.homMap a b))
         (M.tensor (D.comp (F.objMap a) (G.objMap a) (G.objMap b)) (G.homMap a b)) :=
...
noncomputable def tensorCoherencePath (a b : V) :
...
noncomputable def tensorCoherenceInv (a b : V) :
...
noncomputable def changeOfBase_hom_path {V : Type u} {W : Type u}
    {MV : MonoidalData V} {MW : MonoidalData W}
    (L : LaxMonoidalFunctor V W MV MW)
    (C : VEnrichedCat V MV)
...
noncomputable def homIsoPath (adj : VAdjunctionData F G) (a : C.Obj) (b : D.Obj) :
...
noncomputable def homIsoInv (adj : VAdjunctionData F G) (a : C.Obj) (b : D.Obj) :
    Path (C.hom a (G.objMap b)) (D.hom (F.objMap a) b) :=
  Path.symm (adj.homIsoPath a b)

-- Theorem 31: Adjunction iso round-trip
noncomputable def homIsoRoundtrip (adj : VAdjunctionData F G) (a : C.Obj) (b : D.Obj) :
...
noncomputable def homIsoCongrArg (adj : VAdjunctionData F G) (a : C.Obj) (b : D.Obj)
    (f : V → V) :
...
noncomputable def universalityPath (lim : VWeightedLimit C J W Diag) (x : C.Obj) (j : J.Obj) :
...
noncomputable def universalityInv (lim : VWeightedLimit C J W Diag) (x : C.Obj) (j : J.Obj) :
...
noncomputable def VWeightedColimit.universalityPath {V : Type u} {M : MonoidalData V}
...
noncomputable def VWeightedColimit.universalityInv {V : Type u} {M : MonoidalData V}
    {C J : VEnrichedCat V M} {W : J.Obj → V} {Diag : J.Obj → C.Obj}
    (colim : VWeightedColimit C J W Diag) (x : C.Obj) (j : J.Obj) :
...
noncomputable def VEnd.dinaturalityPath {V : Type u} {M : MonoidalData V}
...
noncomputable def VEnd.dinaturalityInv {V : Type u} {M : MonoidalData V}
    {C : VEnrichedCat V M} {T : C.Obj → C.Obj → V}
    (e : VEnd C T) (a b : C.Obj) :
...
noncomputable def VCoend.dinaturalityPath {V : Type u} {M : MonoidalData V}
    {C : VEnrichedCat V M} {T : C.Obj → C.Obj → V}
...
noncomputable def VCoend.dinaturalityInv {V : Type u} {M : MonoidalData V}
    {C : VEnrichedCat V M} {T : C.Obj → C.Obj → V}
    (ce : VCoend C T) (a b : C.Obj) :
...
noncomputable def representable {V : Type u} {M : MonoidalData V}
...
noncomputable def representable_action {V : Type u} {M : MonoidalData V}
...
noncomputable def YonedaIso.leftInversePath {V : Type u} {M : MonoidalData V}
...
noncomputable def YonedaIso.leftInverseInv {V : Type u} {M : MonoidalData V}
    {C : VEnrichedCat V M} {a : C.Obj} {F : C.Obj → V}
    (Y : YonedaIso C a F) :
...
noncomputable def YonedaIso.rightInversePath {V : Type u} {M : MonoidalData V}
    {C : VEnrichedCat V M} {a : C.Obj} {F : C.Obj → V}
    (Y : YonedaIso C a F) :
...
noncomputable def YonedaIso.rightInverseInv {V : Type u} {M : MonoidalData V}
    {C : VEnrichedCat V M} {a : C.Obj} {F : C.Obj → V}
    (Y : YonedaIso C a F) :
...
noncomputable def YonedaIso.leftRoundtrip {V : Type u} {M : MonoidalData V}
    {C : VEnrichedCat V M} {a : C.Obj} {F : C.Obj → V}
    (Y : YonedaIso C a F) :
...
noncomputable def DayConvolution.coendWitnessPath {V : Type u} {M : MonoidalData V}
...
noncomputable def DayConvolution.coendWitnessInv {V : Type u} {M : MonoidalData V}
    {C : VEnrichedCat V M} {P Q : C.Obj → V} {tO : C.Obj → C.Obj → C.Obj}
    (D : DayConvolution C P Q tO) (c a b : C.Obj) :
...
noncomputable def VProfunctor.coherencePath {V : Type u} {M : MonoidalData V}
...
noncomputable def VProfunctor.coherenceInv {V : Type u} {M : MonoidalData V}
    {C D : VEnrichedCat V M} (P : VProfunctor C D)
    (a b : D.Obj) (c : C.Obj) :
...
noncomputable def VPower.isoPath {V : Type u} {M : MonoidalData V}
...
noncomputable def VPower.isoInv {V : Type u} {M : MonoidalData V}
    {C : VEnrichedCat V M} {v : V} {c : C.Obj}
    (pw : VPower C v c) (x : C.Obj) :
...
noncomputable def VCopower.isoPath {V : Type u} {M : MonoidalData V}
    {C : VEnrichedCat V M} {v : V} {c : C.Obj}
...
noncomputable def VCopower.isoInv {V : Type u} {M : MonoidalData V}
    {C : VEnrichedCat V M} {v : V} {c : C.Obj}
    (cp : VCopower C v c) (x : C.Obj) :
...
noncomputable def VLeftKan.counitPath {V : Type u} {M : MonoidalData V}
...
noncomputable def VLeftKan.counitInv {V : Type u} {M : MonoidalData V}
    {C D : VEnrichedCat V M} {K : VFunctor C D} {F : C.Obj → V}
    (lan : VLeftKan K F) (c : C.Obj) :
...
noncomputable def VRightKan.unitPath {V : Type u} {M : MonoidalData V}
    {C D : VEnrichedCat V M} {K : VFunctor C D} {F : C.Obj → V}
...
noncomputable def VRightKan.unitInv {V : Type u} {M : MonoidalData V}
    {C D : VEnrichedCat V M} {K : VFunctor C D} {F : C.Obj → V}
    (ran : VRightKan K F) (c : C.Obj) :
...
noncomputable def VEquivalence.unitIsoPath {V : Type u} {M : MonoidalData V}
...
noncomputable def VEquivalence.unitIsoInv {V : Type u} {M : MonoidalData V}
    {C D : VEnrichedCat V M} (E : VEquivalence C D) (a : C.Obj) :
...
noncomputable def VEquivalence.counitIsoPath {V : Type u} {M : MonoidalData V}
...
noncomputable def VMonad.leftUnitLawPath {V : Type u} {M : MonoidalData V}
...
noncomputable def VMonad.leftUnitLawInv {V : Type u} {M : MonoidalData V}
    {C : VEnrichedCat V M} (monad : VMonad C) (a : C.Obj) :
...
noncomputable def VMonad.rightUnitLawPath {V : Type u} {M : MonoidalData V}
    {C : VEnrichedCat V M} (monad : VMonad C) (a : C.Obj) :
...
noncomputable def VMonad.rightUnitLawInv {V : Type u} {M : MonoidalData V}
    {C : VEnrichedCat V M} (monad : VMonad C) (a : C.Obj) :
    Path (C.id_ (monad.T a))
...
noncomputable def VMonad.leftToRightUnit {V : Type u} {M : MonoidalData V}
    {C : VEnrichedCat V M} (monad : VMonad C) (a : C.Obj) :
    Path (M.tensor (monad.mu a) (monad.eta (monad.T a)))
         (M.tensor (monad.mu a) (monad.eta a)) :=
...
noncomputable def VComonad.leftCounitLawPath {V : Type u} {M : MonoidalData V}
...
noncomputable def VComonad.leftCounitLawInv {V : Type u} {M : MonoidalData V}
    {C : VEnrichedCat V M} (comonad : VComonad C) (a : C.Obj) :
...
noncomputable def congrArg_tensor_left {V : Type u} (M : MonoidalData V)
...
noncomputable def congrArg_tensor_right {V : Type u} (M : MonoidalData V)
    (a : V) {b b' : V} (p : Path b b') :
    Path (M.tensor a b) (M.tensor a b') :=
  Path.congrArg (fun x => M.tensor a x) p

-- Theorem 71: congrArg composed with trans
noncomputable def congrArg_trans_composed {A B : Type u} (f : A → B)
    {a b c : A} (p : Path a b) (q : Path b c) :
    Path (f a) (f c) :=
  Path.congrArg f (Path.trans p q)

-- Theorem 72: congrArg composed with symm
noncomputable def congrArg_symm_composed {A B : Type u} (f : A → B)
    {a b : A} (p : Path a b) :
    Path (f b) (f a) :=
  Path.congrArg f (Path.symm p)

-- Theorem 73: Double congrArg
noncomputable def double_congrArg {A B C : Type u} (f : A → B) (g : B → C)
    {a a' : A} (p : Path a a') :
    Path (g (f a)) (g (f a')) :=
  Path.congrArg g (Path.congrArg f p)

-- Theorem 74: congrArg preserves refl
noncomputable def congrArg_refl_pres {A B : Type u} (f : A → B) (a : A) :
    Path (f a) (f a) :=
...
noncomputable def three_fold_trans {A : Type u} {a b c d : A}
...
noncomputable def double_symm {A : Type u} {a b : A} (p : Path a b) :
    Path a b :=
