...
noncomputable def rweq_of_operadic_step {A : Type u} {a b : A}
...
noncomputable def rweq_of_operad_algebra_step_infra {A : Type u} {a b : A}
...
noncomputable def rweq_of_koszul_step_infra {A : Type u} {a b : A}
