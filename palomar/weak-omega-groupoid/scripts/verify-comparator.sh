...
# These are the verifier pins used by the Palomar readiness workflow on
# 2026-08-30. They are kept here so the nested project can be replayed without
# depending on a mutable repository branch.
