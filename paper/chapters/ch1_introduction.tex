...
cells. Our 76-rule rewrite system on paths (\cref{ch:rewrite-system}) can be
...
\begin{description}[leftmargin=2em,style=nextline]
  ...
  \item[\Cref{ch:rewrite-system}: The Rewrite System.]
    ...
    (the strip lemma) and global confluence (via Newman's lemma), and construct
    the quotient $\PathQuot$.
