...
\begin{definition}[Single-Step Rewrite]\label{def:step-rewrite}
  ...
  the 76 rules organized into eight groups below. We write
...
\begin{proof}
  By induction on the derivation of $\Step(p, q)$. Each of the 76 rules
...
\begin{proof}
  By case analysis on the 76 rules. Each rule either reduces the symbol
...
\begin{proof}
  ...
  join. The analysis covers all pairs among the 76 rules.
\end{proof}
