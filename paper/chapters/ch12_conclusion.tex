...
\midrule
Lean 4 source files & 516 \\
Total lines of code & 113,024 \\
Definitions (\texttt{def}, \texttt{noncomputable def}) & 3,258 \\
Theorems (\texttt{theorem}) & 1,466 \\
Structures (\texttt{structure}) & 2,711 \\
Inductive types (\texttt{inductive}) & 190 \\
\bottomrule
\end{tabular}
\end{center}
