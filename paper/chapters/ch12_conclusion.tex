...
\midrule
Lean 4 source files & 856 \\
Total lines of code & 217,000 \\
Definitions (\texttt{def}, \texttt{noncomputable def}) & 8,191 \\
Theorems (\texttt{theorem}) & 3,532 \\
Structures (\texttt{structure}) & 4,746 \\
Inductive types (\texttt{inductive}) & 327 \\
\bottomrule
\end{tabular}
\end{center}
