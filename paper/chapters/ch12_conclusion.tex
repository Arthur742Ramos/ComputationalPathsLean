...
\midrule
Lean 4 source files & 947 \\
Total lines of code & 232,190 \\
Definitions (\texttt{def}, \texttt{noncomputable def}) & 9,044 \\
Theorems (\texttt{theorem}) & 9,570 \\
Structures (\texttt{structure}) & 4,299 \\
Inductive types (\texttt{inductive}) & 394 \\
\bottomrule
\end{tabular}
\end{center}
...
With all 75 rules and their congruence variants registered as
...
The current formalization of 232,190 lines covers a substantial portion
