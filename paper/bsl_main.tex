...
%% ============================================================================
%% Chapter 8: The Rewrite System: Metatheory
...
\midrule
Decidability of $\RwEq$ (Thm.~8.8) & \S\ref{ch:metatheory} & FF \\
$J$-Elimination (Thm.~8.11) & \S\ref{ch:metatheory} & FF \\
HoTT Compatibility (Thm.~8.13) & \S\ref{ch:metatheory} & FF \\
\bottomrule
\end{tabular}
\end{table}
