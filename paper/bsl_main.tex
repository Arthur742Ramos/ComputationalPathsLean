...
confluent, terminating rewrite system whose 74~rules (the count of 74 follows
from the distinct constructors in our formalization; the earlier convention of
76 in~\cite{ramos18} counted two context-congruence rules that serve double
duty) are organized into eight groups covering path algebra, type-former
$\beta/\eta$-rules, transport,
...
\begin{keywords}
computational paths, identity types, weak $\omega$-groupoid, rewrite system,
type theory, higher-dimensional algebra, formalization
\end{keywords}
