...
and theorem manifest are archived as Zenodo version~0.4.0 at
\url{https://doi.org/10.5281/zenodo.21762344}; the corresponding source
release is
\url{https://github.com/Arthur742Ramos/ComputationalPathsLean/releases/tag/v0.4.0}.
\end{abstract}
...
\begin{enumerate}
    ...
    \begin{itemize}
        ...
        \item \path{continuousPresentedTopologicalGroupoidCertificate}
        specializes the construction to every presented realization, while
        \path{continuousAmbientTopologicalGroupoidCertificate} transports it
    ...
    \begin{itemize}
        \item 21,012 lines across the 31 modules used by this paper
...
Zenodo version~0.4.0:
\url{https://doi.org/10.5281/zenodo.21762344}.
...
license, theorem manifest, and invariant checker.  Its archive SHA-256 is
\texttt{496e2d998d7efc46169d64c3e46d2f643a688cd45889d381f8031ecdec3b8cfd}.
...
\subsection{The Weak \texorpdfstring{$\omega$}{omega}-Groupoid Structure}
...
\leanname{Homotopy/PresentedAmbientContinuousGeometricAdapter} &
Ambient-homotopy-equivalence specialization of the certificate \\
\leanname{Homotopy/HigherHomotopy} & $\piN$ for $n \geq 2$ \\
...
\leanname{OmegaGroupoid} & Weak $\omega$-groupoid structure \\
\end{longtable}
}
...
\midrule
Lean lines in the 31-module formalization core & 21,012 \\
...
\subsection{Weak \texorpdfstring{$\omega$}{omega}-Groupoid Structure}
...
\begin{enumerate}
    ...
    \item The thirty-one modules used by the paper comprise 21,012 lines, and the
...
\newblock Lean 4 formalization artifact for the Seifert--van Kampen theorem via computational paths, version 0.4.0.
\newblock Zenodo, 2026. \url{https://doi.org/10.5281/zenodo.21762344}.
...
\leanentry{unconditionalTopologicalGroupoidCertificate}
