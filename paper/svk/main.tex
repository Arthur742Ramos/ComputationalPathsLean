...
\url{https://doi.org/10.5281/zenodo.21745185}.
\end{abstract}
...
version~0.3.0 at Zenodo:
\url{https://doi.org/10.5281/zenodo.21745185}.
It contains the 28 paper entry modules and their 45 transitive local
dependencies (73 Lean files total), the pinned Lean/Lake configuration, MIT
license, theorem manifest, and invariant checker.  The standalone commands are
\texttt{lake update},
...
\newblock Lean 4 formalization artifact for the Seifert--van Kampen theorem via computational paths, version 0.3.0.
\newblock Zenodo, 2026. \url{https://doi.org/10.5281/zenodo.21745185}.
