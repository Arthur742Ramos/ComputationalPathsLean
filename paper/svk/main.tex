...
The twenty-eight Lean modules in the formalization core described here comprise
\textbf{20,351 lines}.
...
\begin{enumerate}
    ...
    \begin{itemize}
        \item 20,351 lines across the 28 modules used by this paper
...
comment-stripped lexical count.  None of the 20,243 declarations introduced with
\texttt{theorem}/\texttt{lemma} directly invokes a \texttt{path\_*} tactic.
Across all 53,956 declarations counted (including \texttt{def},
\texttt{instance}, and \texttt{example}), 11 invoke one directly
(approximately \(0.020\%\)).  In the twenty-eight modules used by this paper,
one of 1,411 declarations does so (\(0.071\%\)).  Thus the tactics are
...
\midrule
Lean lines in the 28-module formalization core & 20,351 \\
Modules in the formalization core & 28 \\
...
\begin{enumerate}
    ...
    \item The twenty-eight modules used by the paper comprise 20,351 lines, and the
