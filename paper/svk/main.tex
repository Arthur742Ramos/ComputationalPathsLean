...
\url{https://doi.org/10.5281/zenodo.21716462}.
\end{abstract}
...
version~0.2.0 at Zenodo:
\url{https://doi.org/10.5281/zenodo.21716462}.
It contains the 27 paper entry modules and their 44 transitive local
dependencies (71 Lean files total), the pinned Lean/Lake configuration, MIT
...
\begin{enumerate}
    ...
    realization.  Theorem~\ref{thm:circle-realization} remains a separate
    comparison with the concrete space \(\mathsf{AddCircle}\,1\).
...
\begin{enumerate}
    ...
    \item \textbf{From presentations to ambient spaces}: For presentations
    extracted from concrete CW decompositions, compare the canonical nerve
    realization with the original ambient space and extend the present
    fundamental-groupoid result to higher homotopy invariants.
...
\newblock Lean 4 formalization artifact for the Seifert--van Kampen theorem via computational paths, version 0.2.0.
\newblock Zenodo, 2026. \url{https://doi.org/10.5281/zenodo.21716462}.
