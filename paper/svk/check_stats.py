...
SVK_CORE = [
    ...
    SRC / "Path/Homotopy/TopologicalNerveContractible.lean",
    SRC / "Path/Homotopy/TopologicalRealizationOpen.lean",
    SRC / "Path/Homotopy/TopologicalSimplexStar.lean",
    SRC / "Path/Homotopy/TopologicalNerveCover.lean",
    SRC / "Path/Homotopy/TopologicalNerveComparison.lean",
    SRC / "Path/Homotopy/PresentedGroupoidRealization.lean",
    SRC / "Path/Topology/TopologicalCompPathGroupoidLaws.lean",
    SRC / "Path/Homotopy/PresentedContinuousGeometricAdapter.lean",
    SRC / "Path/Homotopy/PresentedAmbientContinuousGeometricAdapter.lean",
