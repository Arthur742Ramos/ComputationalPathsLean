...
\address{Center for Informatics (CIn), Universidade Federal de Pernambuco (UFPE)}
...
We define steps, paths, and rewrite equivalence; prove soundness and
congruence properties; and establish Church--Rosser confluence for the
completed groupoid fragment via a free-group interpretation.
...
\(\omega\)-groupoid structure in the sense of Batanin--Leinster.
