% ============================================================================
% The Algebra of Computational Paths — Complete Paper
% ============================================================================
...
% ============================================================================
\title{\textbf{The Algebra of Computational Paths}\\[6pt]
  \large A Lean~4 Formalization of Rewrite-Trace Equality,\\
  Weak $\omega$-Groupoids, and Homotopy Theory}

\author{
  Arthur Ferreira Ramos\thanks{Centro de Inform\'atica, Universidade Federal
    de Pernambuco, Recife, Brazil. \texttt{afr@cin.ufpe.br}}
  \and
...
paths is equipped with a confluent, terminating rewrite system whose 76~rules
...
lens spaces. The entire development is formalized in Lean~4 (302~files,
60,860~lines, 1,710~definitions, 885~theorems, 701~structures).
\end{abstract}
