...
The current Lean artifact snapshot is archived as
\href{https://doi.org/10.5281/zenodo.21817208}
{\nolinkurl{doi:10.5281/zenodo.21817208}} and corresponds to the immutable tag
\texttt{topological-paper-v4} in the
\href{https://github.com/Arthur742Ramos/ComputationalPathsLean}{GitHub repository}.
This release includes the finite-generator module and the torus
simultaneous/sequential bridge.  The literal root reproducibility command is
