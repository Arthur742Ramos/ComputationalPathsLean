...
rewrites alone generate syntactic identifications; arbitrary endpoint-fixed
...
\[
  ...
  \rho(e_i(p))(nt-i+1),
\]
where $e_i:W_n\to\widetilde E$ is the $i$th coordinate and the inverse-copy
interpretation of $\rho$ is understood on $E^-$.  Continuity follows from the
continuity of $\rho$ and of evaluation for the compact-open topology.  On a
...
The Lean core artifact, version \texttt{0.5.5+lean-only-v1}, is archived on Zenodo
under the version DOI
\href{https://doi.org/10.5281/zenodo.21817877}
{\nolinkurl{doi:10.5281/zenodo.21817877}}; its permanent concept DOI is
