...
therefore topologically indistinguishable in $T_{\mathrm{obs}}$.  Since no
scoped rule identifies them, and the reduced-word invariant for the structural
unit, associativity, and cancellation coherences keeps the two one-letter
words distinct; hence their quotient classes remain distinct, but the
singleton $\{q_{\mathrm{obs}}(u_e)\}$ is not open.  Consequently the
continuous bijection
\[
