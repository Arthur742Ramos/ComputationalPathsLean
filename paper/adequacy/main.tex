...
quotient; and a factorization theorem for equality-projection motives.  Each of
these is an elementary consequence of equality induction and quotient
soundness, and we present them as such.  Their value is not individual: it is
that the chain they form converts an unquantifiable question about all motives
into a condition on raw representatives, which is what makes the case study
...
The chain has four links, and each is used exactly once downstream:
