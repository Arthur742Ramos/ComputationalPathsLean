...
identity type.  The raw de Bruijn calculus developed alongside this work is
published separately as a self-contained article
\cite{ScopedTraceCalculus2026}; Section~\ref{sec:formalization} describes the
division.
