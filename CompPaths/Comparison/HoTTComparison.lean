...
/-! ## (2) CompPaths interface: Path.trans / Path.symm / Step / RwEq -/
...
/-! ## (4) What CompPaths has beyond HoTT's primitive identity interface -/
...
/-! ## (5) HoTT-only primitives vs CompPaths rewrite infrastructure -/
