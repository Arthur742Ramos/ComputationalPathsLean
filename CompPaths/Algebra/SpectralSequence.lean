...
theorem collapses_at_E2_of_confluent {A : Type u} {a : A}
    (hConf : CompPaths.Confluence.StepConfluent (A := A) (a := a) (b := a)) :
    CollapsesAtE2 A a := by
  intro p q h
  exact CompPaths.Confluence.church_rosser_rweq
    (A := A) (a := a) (b := a) hConf h
...
theorem collapses_at_E2_of_complete {A : Type u} {a : A}
    ...
    (hLocal : CompPaths.Confluence.StepLocallyConfluent (A := A) (a := a) (b := a)) :
    CollapsesAtE2 A a := by
  have hConf : CompPaths.Confluence.StepConfluent (A := A) (a := a) (b := a) :=
    CompPaths.Confluence.step_newman_lemma
