...
import CompPaths.Rewriting.KnuthBendix
import ComputationalPaths.Path.Rewrite.GroupoidTRS

namespace CompPaths.Rewriting.TerminationProofs

open ComputationalPaths.Path.Rewrite.GroupoidTRS (Expr)
open CompPaths.Rewriting (StepRule RuleShape shapeExprPair)
...
end CompPaths.Rewriting.TerminationProofs
